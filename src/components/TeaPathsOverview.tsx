    ...
    >
      <header className="section-heading section-heading--split">
        ...
        <p>
          ...
          <InlineDefinition
            term="шайцин"
            definition="Солнечная сушка листа; её результатом для пуэра становится шайцин-маоча — чай-сырец."
          />
          -маоча. Развилка начинается после получения этого чайного сырья.
        </p>
      </header>
